...
{
public:
  explicit Init_AddTwoInts_Event_response(::arduinobot_messages::srv::AddTwoInts_Event & msg)
  : msg_(msg)
  {}
  ::arduinobot_messages::srv::AddTwoInts_Event response(::arduinobot_messages::srv::AddTwoInts_Event::_response_type arg)
  {
...
private:
  ::arduinobot_messages::srv::AddTwoInts_Event msg_;
};

class Init_AddTwoInts_Event_request
{
public:
  explicit Init_AddTwoInts_Event_request(::arduinobot_messages::srv::AddTwoInts_Event & msg)
  : msg_(msg)
  {}
  Init_AddTwoInts_Event_response request(::arduinobot_messages::srv::AddTwoInts_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_AddTwoInts_Event_request info(::arduinobot_messages::srv::AddTwoInts_Event::_info_type arg)
  {
...
template<>
inline
auto build<::arduinobot_messages::srv::AddTwoInts_Event>()
{
  return arduinobot_messages::srv::builder::Init_AddTwoInts_Event_info();
}
