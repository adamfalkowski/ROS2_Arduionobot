...
static const _QuaternionToEuler_Event_type_support_symbol_names_t _QuaternionToEuler_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arduinobot_messages, srv, QuaternionToEuler_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, arduinobot_messages, srv, QuaternionToEuler_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, arduinobot_messages, srv, QuaternionToEuler_Event)() {
  return &::arduinobot_messages::srv::rosidl_typesupport_c::QuaternionToEuler_Event_message_type_support_handle;
}
