...
static const _EulerToQuaternion_Event_type_support_symbol_names_t _EulerToQuaternion_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arduinobot_messages, srv, EulerToQuaternion_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arduinobot_messages, srv, EulerToQuaternion_Event)),
  }
};
...
{
  return &::arduinobot_messages::srv::rosidl_typesupport_cpp::EulerToQuaternion_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, arduinobot_messages, srv, EulerToQuaternion_Event)() {
  return get_message_type_support_handle<arduinobot_messages::srv::EulerToQuaternion_Event>();
}
...
static const rosidl_service_type_support_t EulerToQuaternion_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<arduinobot_messages::srv::EulerToQuaternion_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<arduinobot_messages::srv::EulerToQuaternion_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<arduinobot_messages::srv::EulerToQuaternion_Event>(),
