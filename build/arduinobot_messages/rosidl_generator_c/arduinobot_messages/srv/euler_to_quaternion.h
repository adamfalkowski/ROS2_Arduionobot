...
#ifndef ARDUINOBOT_MESSAGES__SRV__EULER_TO_QUATERNION_H_
#define ARDUINOBOT_MESSAGES__SRV__EULER_TO_QUATERNION_H_
...
#endif  // ARDUINOBOT_MESSAGES__SRV__EULER_TO_QUATERNION_H_
