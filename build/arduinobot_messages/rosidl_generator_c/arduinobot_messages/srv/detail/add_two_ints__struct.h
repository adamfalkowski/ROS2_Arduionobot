...
enum
{
  arduinobot_messages__srv__AddTwoInts_Event__request__MAX_SIZE = 1
};
// response
enum
{
  arduinobot_messages__srv__AddTwoInts_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/AddTwoInts in the package arduinobot_messages.
typedef struct arduinobot_messages__srv__AddTwoInts_Event
{
  service_msgs__msg__ServiceEventInfo info;
  arduinobot_messages__srv__AddTwoInts_Request__Sequence request;
  arduinobot_messages__srv__AddTwoInts_Response__Sequence response;
} arduinobot_messages__srv__AddTwoInts_Event;

// Struct for a sequence of arduinobot_messages__srv__AddTwoInts_Event.
typedef struct arduinobot_messages__srv__AddTwoInts_Event__Sequence
{
