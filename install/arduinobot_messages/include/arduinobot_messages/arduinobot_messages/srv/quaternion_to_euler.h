...
#ifndef ARDUINOBOT_MESSAGES__SRV__QUATERNION_TO_EULER_H_
#define ARDUINOBOT_MESSAGES__SRV__QUATERNION_TO_EULER_H_
...
#endif  // ARDUINOBOT_MESSAGES__SRV__QUATERNION_TO_EULER_H_
