...
// IWYU pragma: private, include "arduinobot_messages/srv/add_two_ints.hpp"


#ifndef ARDUINOBOT_MESSAGES__SRV__DETAIL__ADD_TWO_INTS__STRUCT_HPP_
#define ARDUINOBOT_MESSAGES__SRV__DETAIL__ADD_TWO_INTS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__arduinobot_messages__srv__AddTwoInts_Event __attribute__((deprecated))
#else
# define DEPRECATED__arduinobot_messages__srv__AddTwoInts_Event __declspec(deprecated)
#endif
...
struct AddTwoInts_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<arduinobot_messages::srv::AddTwoInts_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<arduinobot_messages::srv::AddTwoInts_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<arduinobot_messages::srv::AddTwoInts_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<arduinobot_messages::srv::AddTwoInts_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<arduinobot_messages::srv::AddTwoInts_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<arduinobot_messages::srv::AddTwoInts_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<arduinobot_messages::srv::AddTwoInts_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<arduinobot_messages::srv::AddTwoInts_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    arduinobot_messages::srv::AddTwoInts_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const arduinobot_messages::srv::AddTwoInts_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<arduinobot_messages::srv::AddTwoInts_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<arduinobot_messages::srv::AddTwoInts_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      arduinobot_messages::srv::AddTwoInts_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<arduinobot_messages::srv::AddTwoInts_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      arduinobot_messages::srv::AddTwoInts_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<arduinobot_messages::srv::AddTwoInts_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<arduinobot_messages::srv::AddTwoInts_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<arduinobot_messages::srv::AddTwoInts_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__arduinobot_messages__srv__AddTwoInts_Event
    std::shared_ptr<arduinobot_messages::srv::AddTwoInts_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__arduinobot_messages__srv__AddTwoInts_Event
    std::shared_ptr<arduinobot_messages::srv::AddTwoInts_Event_<ContainerAllocator> const>
...
using AddTwoInts_Event =
  arduinobot_messages::srv::AddTwoInts_Event_<std::allocator<void>>;
...
struct AddTwoInts
{
  ...
  using Event = arduinobot_messages::srv::AddTwoInts_Event;
};
...
#endif  // ARDUINOBOT_MESSAGES__SRV__DETAIL__ADD_TWO_INTS__STRUCT_HPP_
