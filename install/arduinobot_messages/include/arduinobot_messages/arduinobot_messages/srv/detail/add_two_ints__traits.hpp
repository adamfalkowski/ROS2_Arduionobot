...
#ifndef ARDUINOBOT_MESSAGES__SRV__DETAIL__ADD_TWO_INTS__TRAITS_HPP_
#define ARDUINOBOT_MESSAGES__SRV__DETAIL__ADD_TWO_INTS__TRAITS_HPP_
...
[[deprecated("use arduinobot_messages::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const arduinobot_messages::srv::AddTwoInts_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  arduinobot_messages::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use arduinobot_messages::srv::to_yaml() instead")]]
inline std::string to_yaml(const arduinobot_messages::srv::AddTwoInts_Event & msg)
{
  return arduinobot_messages::srv::to_yaml(msg);
}

template<>
inline const char * data_type<arduinobot_messages::srv::AddTwoInts_Event>()
{
  return "arduinobot_messages::srv::AddTwoInts_Event";
}

template<>
inline const char * name<arduinobot_messages::srv::AddTwoInts_Event>()
{
  return "arduinobot_messages/srv/AddTwoInts_Event";
}

template<>
struct has_fixed_size<arduinobot_messages::srv::AddTwoInts_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<arduinobot_messages::srv::AddTwoInts_Event>
  : std::integral_constant<bool, has_bounded_size<arduinobot_messages::srv::AddTwoInts_Request>::value && has_bounded_size<arduinobot_messages::srv::AddTwoInts_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<arduinobot_messages::srv::AddTwoInts_Event>
  : std::true_type {};
...
#endif  // ARDUINOBOT_MESSAGES__SRV__DETAIL__ADD_TWO_INTS__TRAITS_HPP_
